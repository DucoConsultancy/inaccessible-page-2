...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (typeof Drupal.settings.leaflet != 'undefined' && $('body').hasClass('page-mow-premise')) {
    ...
    // Print button.
    $('#block-mow-tools-page-tools .print').click(function () {
      window.print();
      return false;
    })
...
<div class="popover-content"></div>\
    ...
    $('#quicktabs-mow_topic_sheet_tabs .nav.nav-tabs').tabCollapse();
    $('.pane-mow-bootstrap-theme-section-outline #accordion').collapse();

    $('#quicktabs-mow_premise_tabs .nav.nav-tabs').tabCollapse();
    $('#quicktabs-mow_premise_tabs1-collapse').collapse();
    ...
    $('#quicktabs-mow_premise_tabs .nav-tabs a, \
           #quicktabs-mow_topic_sheet_tabs .nav-tabs a').on('click', function () {
      var accordionContentId = $(this).attr('href');
      $(accordionContentId + ' h2.tab-title').focus();
    });

    // Add screen-reader only text when a tab is clicked.
    accessibleTabTitles($('#quicktabs-mow_premise_tabs ul.nav-tabs, #quicktabs-mow_topic_sheet_tabs ul.nav-tabs'), true);
    ...
    $('#quicktabs-mow_topic_sheet_tabs #summary-collapse').removeClass('in').addClass('collapse');
  ...
  function searchResize() {
    if ($('.solr-search-facets.active').length) {
      if (!$('body').hasClass('search-moved-tablet')) {
        ...
        $('.pane-current-search-mow-current-search').appendTo('.left');
      ...
      if ($('body').hasClass('search-moved-tablet')) {
        ...
        $('.pane-current-search-mow-current-search').prependTo('.left');
        $('body').removeClass('search-moved-tablet');
      }
    }
    if ($('#mow-prms-map.active').length) {
    ...
    if ($('#mow-prms-map-results.active').length) {
...
$(document).ready(function () {
  ...
  if (typeof(ga) != 'undefined') {
    ...
    $('#block-mow-tools-page-tools .fa-share').click(function() {
...
!function($) {
    ...
    var uniqueId = function(prefix) {
      ...
      , removeMultiValAttributes = function(el, attr, val) {
        ...
        describedby ? el.attr(attr, describedby) : el.removeAttr(attr)
    };
    ...
    $.fn.tooltip.Constructor.prototype.hide = function() {
        return hideTooltip.apply(this, arguments),
    ...
    $.fn.popover.Constructor.prototype.hide = function() {
        return hidePopover.apply(this, arguments),
        removeMultiValAttributes(this.$element, "aria-describedby", this.tip().attr("id")),
        this
    }
    ,
    ...
    $.fn.dropdown.Constructor.prototype.keydown = function(e) {
        var $par;
        /(32)/.test(e.keyCode) && ($par = $(this).parent(),
        $(this).trigger("click"),
    ...
    $(document).on("focusout.dropdown.data-api", ".dropdown-menu", function() {
        var $this = $(this)
          , that = this;
        setTimeout(function() {
            $.contains(that, document.activeElement) || ($this.parent().removeClass("open"),
    ...
    $tabs.each(function() {
        var tabpanel = $($(this).attr("href"))
          ...
          , tabid = tab.attr("id") || uniqueId("ui-tab");
        tab.attr("id", tabid),
        tab.parent().hasClass("active") ? (tab.attr({
            tabIndex: "0",
            "aria-selected": "true",
    ...
    $.fn.tab.Constructor.prototype.keydown = function(e) {
        ...
        /(37|38|39|40)/.test(k)) {
            ...
            "tab" === nextTab.attr("role") && nextTab.tab("show").focus(),
            e.preventDefault(),
            e.stopPropagation()
        }
    }
    ...
    $.fn.collapse.Constructor.prototype.toggle = function() {
        ...
        if (prevTab) {
            ...
            $.support.transition && this.$element.one($.support.transition.end, function() {
                prevTab.attr({
                    "aria-selected": "false",
                    "aria-expanded": "false",
                    tabIndex: "-1"
    ...
    $.fn.collapse.Constructor.prototype.keydown = function(e) {
        ...
        $this = $(this),
        /(32|37|38|39|40)/.test(k) && (32 == k && $this.click(),
    ...
    $.fn.carousel.Constructor.prototype.keydown = function(e) {
        var index, $this = $(this), $ul = $this.closest("div[role=listbox]"), $items = $ul.find("[role=option]"), $parent = $ul.parent(), k = e.which || e.keyCode;
        /(37|38|39|40)/.test(k) && (index = $items.index($items.filter(".active")),
        (37 == k || 38 == k) && ($parent.carousel("prev"),
        index--,
        0 > index ? index = $items.length - 1 : $this.prev().focus()),
        (39 == k || 40 == k) && ($parent.carousel("next"),
        index++,
        index == $items.length ? index = 0 : $this.one($.support.transition.end, function() {
            $this.next().focus()
        })),
        e.preventDefault(),
        e.stopPropagation())
